    ...
    new HtmlWebpackPlugin({
      ...
      templateParameters: (() => {
        if (GLOBALS.MODE === 'production') {
          return {
            title: 'Agree Market | Kelola Tokomu',
            url: 'https://seller.agreeculture.id',
          };
        }
        if (GLOBALS.MODE === 'staging') {
          return {
            title: '[Staging] Agree Market | Kelola Tokomu',
            url: 'https://stage-seller.agreeculture.id',
          };
        }
        return {
          title: '[DEV] Agree Market | Kelola Tokomu',
          url: 'http://agree-market-seller-dashboard-dev.vsan-apps.playcourt.id',
        };
      })(),
